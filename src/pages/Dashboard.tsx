...
import { Calendar, BookOpen, MapPin, User, Bell, FileText, School } from 'lucide-react';
...
const Dashboard = () => {
  ...
  const renderGuestDashboard = () => (
    <>
      <DashboardCard
        title="Campus Map"
        description="Explore the campus with our interactive map."
        icon={<MapPin className="h-5 w-5 text-blue-500" />}
        linkText="View Map"
        linkPath="/map"
      />
      <DashboardCard
        ...
        description="Access important emergency contacts and information."
        icon={<Bell className="h-5 w-5 text-blue-500" />}
